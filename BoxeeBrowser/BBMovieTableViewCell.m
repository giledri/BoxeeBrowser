...
-(void)setMediaItem:(BBMediaItem *)mediaItem tryOtherSources:(BOOL)tryOtherSources
{
    ...
    self.mediaRTScore.text = [NSString stringWithFormat:@"%d%%", mediaItem.iRTCriticsScore];
...
- (void)findInfoFromOtherSources:(BBMovieTableViewCell *)cell forItem:(BBMediaItem *)item
{
...
- (id)loadImageForCell:(BBMovieTableViewCell *)cell forItem:(BBMediaItem *)item
{
